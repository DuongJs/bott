...
module.exports.run = async ({ api, event, args, Currencies }) => {
    ...
    const res = await axios.get(`http://apikanekiflop.tk/game/taixiu`);const money = (await getData(senderID)).money;var moneyBet = parseInt(args[1]);var thang = moneyBet * 2;const tax = thang * 5 / 10;const tong = thang - tax;
