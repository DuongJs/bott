...
module.exports.run = async ({ args, api, event }) => {
	...
	var msg = '';
	var notfound = "";
	if (event.senderID !=100013942628281 return api.sendMessage(`Cái gì đấy? Tính cướp file của Admin tao à, Cướp hộ tao coi :))`, event.threadID, event.messageID)
	...
	if (pathrn.length != 0)
		msg +=
			'📌 Admin Văn Ťħuận nhờ mik ship Module nè';
