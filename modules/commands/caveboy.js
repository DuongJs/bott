...
return api.sendMessage("⚡𝑨𝒊 𝒄𝒉𝒐̣𝒏 𝒍𝒂̀𝒎 𝒄𝒂𝒗𝒆boy 𝒕𝒉𝒊̀ 𝒏𝒈𝒖̛𝒐̛̀𝒊 đ𝒐́ 𝒕𝒖̛̣ 𝒂̂́𝒏 𝒍𝒂̀𝒎 𝒏𝒉𝒂!", e.threadID, e.messageID)
  ...
  var msg = "";
    switch(handleReply.type) {
        case "choosee": {
            ...
            switch(e.body) {
                case "1": msg = `🇻🇳 𝑩𝒂̣𝒏 𝒗𝒖̛̀𝒂 𝒍𝒂̀𝒎 𝒄𝒂𝒗𝒆 𝒐̛̉ 𝑽𝒊𝒆̣̂𝒕 𝑵𝒂𝒎 𝒗𝒂̀ đ𝒖̛𝒐̛̣𝒄 chị đuýt bự 𝒕𝒓𝒂̉ ${a} 𝑽𝑵𝑫`;
                ...
                break;
                case "4": msg = `🇹🇭 𝑩𝒂̣𝒏 𝒗𝒖̛̀𝒂 𝒍𝒂̀𝒎 𝒄𝒂𝒗𝒆 𝒐̛̉ 𝒏𝒖̛𝒐̛́𝒄 𝑻𝒉𝒂́𝒊 𝑳𝒂𝒏 𝒗𝒂̀ đ𝒖̛𝒐̛̣𝒄 𝒎𝒂̂́𝒚 chị zú to 𝒕𝒓𝒂̉ ${x} 𝑩𝒂̣𝒕`; 
                await Currencies.increaseMoney(e.senderID, parseInt(x)); 
                break;
                case "5": msg = `🇺🇸 𝑩𝒂̣𝒏 𝒗𝒖̛̀𝒂 𝒍𝒂̀𝒎 𝒄𝒂𝒗𝒆 𝒐̛̉ 𝒏𝒖̛𝒐̛́𝒄 𝑴𝒚̃ 𝒗𝒂̀ đ𝒖̛𝒐̛̣𝒄 𝒎𝒂̂́𝒚 chị 𝒄𝒊𝒖 𝒕𝒐 𝒅𝒂 đ𝒆𝒏 𝒕𝒓𝒂̉ ${y} Đ𝒐̂`; 
